...
<#assign spaces = "    "/>
<Modal width="1000" v-model="optModal.${optName!}.show" :mask-closable="false" :loading="optModal.${optName!}.okLoading" @on-ok="do${optName?cap_first}()" @on-cancel="cancel${optName?cap_first}()" :title="optModal.${optName!}.title">
